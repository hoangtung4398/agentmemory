...
export interface SkillContextParityDriftSignatureStabilityDiagnosticsInput { project?: unknown; agentId?: unknown; overallBudget?: unknown; usedTokens?: unknown; selectedBlockCount?: unknown; }
export type SkillContextParityDriftSignatureSamplingMode = "sequential_double_signature_sample_non_atomic";
export type SkillContextParityDriftSignatureStabilityDiagnosticsState = "disabled" | "failed" | "signature_stable" | "signature_drift";
export type SkillContextParityDriftSignatureStabilityDiagnosticsReasonCode = "context_disabled" | "invalid_input" | "first_signature_trigger_failure" | "invalid_first_signature_result" | "first_signature_classification_unavailable" | "second_signature_trigger_failure" | "invalid_second_signature_result" | "second_signature_classification_unavailable" | "signature_stable" | "signature_drift_observed";
export interface SkillContextParityDriftSignatureStabilityDiagnosticsResult { success: boolean; enabled: boolean; applied: false; state: SkillContextParityDriftSignatureStabilityDiagnosticsState; reasonCodes: SkillContextParityDriftSignatureStabilityDiagnosticsReasonCode[]; reason?: string; signatureSamplingMode: SkillContextParityDriftSignatureSamplingMode; stabilityAvailable: boolean; firstSignatureTriggerAttempted: boolean; firstSignatureTriggerSucceeded: boolean; firstSignatureResultParsed: boolean; secondSignatureTriggerAttempted: boolean; secondSignatureTriggerSucceeded: boolean; secondSignatureResultParsed: boolean; stableAcrossSamples: boolean; signatureChanged: boolean; }
export interface SkillContextParityDriftSignatureStabilityEvaluation { stableAcrossSamples: boolean; signatureChanged: boolean; }
export interface SkillContextParityDriftSignatureTransitionDiagnosticsInput { project?: unknown; agentId?: unknown; overallBudget?: unknown; usedTokens?: unknown; selectedBlockCount?: unknown; }
export type SkillContextParityDriftSignatureFamily = "stable_consistent" | "stable_mismatch" | "observed_drift";
export type SkillContextParityDriftSignatureTransitionClass = "same_signature" | "stable_mismatch_variant_changed" | "observed_drift_variant_changed" | "stable_consistent_to_stable_mismatch" | "stable_consistent_to_observed_drift" | "stable_mismatch_to_stable_consistent" | "stable_mismatch_to_observed_drift" | "observed_drift_to_stable_consistent" | "observed_drift_to_stable_mismatch";
export type SkillContextParityDriftSignatureTransitionDiagnosticsState = "disabled" | "failed" | "signature_unchanged" | "signature_transition";
export type SkillContextParityDriftSignatureTransitionDiagnosticsReasonCode = "context_disabled" | "invalid_input" | "first_signature_trigger_failure" | "invalid_first_signature_result" | "first_signature_classification_unavailable" | "second_signature_trigger_failure" | "invalid_second_signature_result" | "second_signature_classification_unavailable" | "signature_unchanged" | "signature_transition_observed";
export interface SkillContextParityDriftSignatureTransitionDiagnosticsResult { success: boolean; enabled: boolean; applied: false; state: SkillContextParityDriftSignatureTransitionDiagnosticsState; reasonCodes: SkillContextParityDriftSignatureTransitionDiagnosticsReasonCode[]; reason?: string; transitionSamplingMode: "sequential_double_signature_transition_sample_non_atomic"; transitionAvailable: boolean; firstSignatureTriggerAttempted: boolean; firstSignatureTriggerSucceeded: boolean; firstSignatureResultParsed: boolean; secondSignatureTriggerAttempted: boolean; secondSignatureTriggerSucceeded: boolean; secondSignatureResultParsed: boolean; transitionClass: SkillContextParityDriftSignatureTransitionClass | null; signatureChanged: boolean; familyChanged: boolean; }
export interface SkillContextParityDriftSignatureTransitionStabilityDiagnosticsInput { project?: unknown; agentId?: unknown; overallBudget?: unknown; usedTokens?: unknown; selectedBlockCount?: unknown; }
export type SkillContextParityDriftSignatureTransitionStabilityDiagnosticsState = "disabled" | "failed" | "transition_stable" | "transition_drift";
export type SkillContextParityDriftSignatureTransitionStabilityDiagnosticsReasonCode = "context_disabled" | "invalid_input" | "first_transition_trigger_failure" | "invalid_first_transition_result" | "first_transition_classification_unavailable" | "second_transition_trigger_failure" | "invalid_second_transition_result" | "second_transition_classification_unavailable" | "transition_stable" | "transition_drift_observed";
export interface SkillContextParityDriftSignatureTransitionStabilityDiagnosticsResult { success: boolean; enabled: boolean; applied: false; state: SkillContextParityDriftSignatureTransitionStabilityDiagnosticsState; reasonCodes: SkillContextParityDriftSignatureTransitionStabilityDiagnosticsReasonCode[]; reason?: string; transitionStabilitySamplingMode: "sequential_double_transition_stability_sample_non_atomic"; stabilityAvailable: boolean; firstTransitionTriggerAttempted: boolean; firstTransitionTriggerSucceeded: boolean; firstTransitionResultParsed: boolean; secondTransitionTriggerAttempted: boolean; secondTransitionTriggerSucceeded: boolean; secondTransitionResultParsed: boolean; stableAcrossSamples: boolean; transitionChanged: boolean; }
export interface SkillContextParityDriftSignatureTransitionStabilityEvaluation { stableAcrossSamples: boolean; transitionChanged: boolean; }
