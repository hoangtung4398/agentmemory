...
| GET | `/agentmemory/decision/audit` |
| GET | `/agentmemory/decision/candidates` |
...
| GET | `/agentmemory/skill-feedback/diagnostics` |
| GET | `/agentmemory/skills` |
| GET | `/agentmemory/skills/promotion-eligibility` |
| GET | `/agentmemory/skills/promotion-inventory` |
| POST | `/agentmemory/skills/recall` |
