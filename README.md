...
- `@agentmemory/mcp` as an MCP server (proxies all 56 tools when `AGENTMEMORY_URL` points at a running agentmemory server; falls back to 7 tools locally when no server is reachable)
