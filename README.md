...
| `memory_decision_audit` | Decision Engine audit diagnostics |
...
# CONSOLIDATION_ENABLED=false   # on by default when an LLM provider is configured
 # AGENTMEMORY_SKILLS=false      # OFF by default. Gates independently configured AgentSkill diagnostics, recall, promotion, explicit feedback, and feedback diagnostics.
 ...
 # AGENTMEMORY_SKILL_RECALL_LIMIT=3 # Bounded to 1..10 advisory checklists.
 # AGENTMEMORY_SKILL_RECALL_MIN_CONFIDENCE=0.7 # Bounded to the AgentSkill 0..1 confidence scale.
...
| `GET` | `/agentmemory/skill-feedback/diagnostics?skillId=<id>` | Authenticated read-only skill feedback diagnostics |
