...
describe("AgentSkill read model configuration", () => {
  ...
  it("keeps lifecycle review independent from feedback, diagnostics, reduction, and recall", async () => {
  ...
  it("keeps read-only feedback reduction planning independent from feedback recording", async () => {
